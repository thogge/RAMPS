...
completed_fields = []
freq_list = ["23694","23722","23870","24139","24532","22235","21301","21431","21550","21981","22344","23444","23963"]
freq_to_trans_dict = {"23694":"NH3_1-1","23722":"NH3_2-2","23870":"NH3_3-3","24139":"NH3_4-4","24532":"NH3_5-5","22235":"H2O","21301":"HC5N_8-7","21431":"HC7N_19-18","21550":"CH3OH_12-11","21981":"HNCO_1-0","22344":"CCS_2-1","23444":"CH3OH_10-9","23963":"HC5N_9-8"}
vmins = np.array(["-30","-30","-30","-30","-30","-140","-30","-30","-140","-30","-30","-140","-30"])
vmaxs = np.array(["140","140","140","140","140","140","140","140","140","140","140","140","140"])
downsamples = np.array(["11","11","11","11","11","7","11","11","7","11","11","7","11"])
...
for field in fields:
    ...
    for i,freq in enumerate(freq_list):
        ...
        if not os.path.exists(combine_file):
            execute_string = "python "+scripts_dir+"combine_raw_fits_data.py -i "+combine_input_string+" -o "+combine_file+" -r "+regrid_file+" -n "+str(numcores)+" -csd"
            print(execute_string)
            os.system(execute_string)
        ...
        if not os.path.exists(fixed_file) and not os.path.exists(mom0_file) and not os.path.exists(mom1_file):
            execute_string = "python "+scripts_dir+"output_baselined_data.py -i "+crop_file+" -o L"+field+"_"+freq_to_trans_dict[freq]+" -s "+downsamples[i]+" -w 20 -f01 -p 3 -n 28"
            print(execute_string)
            os.system(execute_string)
